...
<html>
 ...
 <form action="PermissionCodeDbms.jsp" method="POST">
       Enter The Confirmation Code     <input type="text" name="eventid" value="" />
        <input type="submit" name="conf" value="Confirmation Code" />
        </form>
